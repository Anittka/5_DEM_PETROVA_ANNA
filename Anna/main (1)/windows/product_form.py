...
class ProductForm(ctk.CTkToplevel):
    ...
    def create_form_fields(self):
        ...
        # Наименование
        ctk.CTkLabel(self.main_frame, text="Наименование:", font=("Arial", 14)).pack(anchor="w", pady=2)
        self.name_entry = ctk.CTkEntry(self.main_frame, width=600, font=("Arial", 14))
        self.name_entry.pack(pady=5, fill="x")
        
        # Категория (выпадающий список)
        ctk.CTkLabel(self.main_frame, text="Категория:", font=("Arial", 14)).pack(anchor="w", pady=2)
        ...
        self.category_combo.pack(pady=20, fill="x")
        
        # ;) Артикул (добавлен согласно заданию) +1 
        ctk.CTkLabel(self.main_frame, text="Артикул:", font=("Arial", 14)).pack(anchor="w", pady=2)
        self.article_entry = ctk.CTkEntry(self.main_frame, width=600, font=("Arial", 14), placeholder_text="Уникальный артикул товара")
        self.article_entry.pack(pady=20, fill="x")
        
        # Описание
        ctk.CTkLabel(self.main_frame, text="Описание:", font=("Arial", 14)).pack(anchor="w", pady=2)
        self.description_text = ctk.CTkTextbox(self.main_frame, height=120, width=600, font=("Arial", 14))
        self.description_text.pack(pady=20, fill="x")
        
        # Производитель
        ctk.CTkLabel(self.main_frame, text="Производитель:", font=("Arial", 14)).pack(anchor="w", pady=2)
        self.manufacturer_entry = ctk.CTkEntry(self.main_frame, width=600, font=("Arial", 14))
        self.manufacturer_entry.pack(pady=20, fill="x")
        
        # Поставщик (выпадающий список)
        ctk.CTkLabel(self.main_frame, text="Поставщик:", font=("Arial", 14)).pack(anchor="w", pady=2)
        ...
        self.supplier_combo.pack(pady=20, fill="x")
        
        # Цена
        ctk.CTkLabel(self.main_frame, text="Цена:", font=("Arial", 14)).pack(anchor="w", pady=2)
        self.price_entry = ctk.CTkEntry(self.main_frame, width=600, font=("Arial", 14))
        self.price_entry.pack(pady=20, fill="x")
        
        # Единица измерения
        ctk.CTkLabel(self.main_frame, text="Единица измерения:", font=("Arial", 14)).pack(anchor="w", pady=2)
        self.unit_entry = ctk.CTkEntry(self.main_frame, width=600, font=("Arial", 14), placeholder_text="шт, кг, л...")
        self.unit_entry.pack(pady=20, fill="x")
        
        # Количество на складе
        ctk.CTkLabel(self.main_frame, text="Количество на складе:", font=("Arial", 14)).pack(anchor="w", pady=2)
        self.quantity_entry = ctk.CTkEntry(self.main_frame, width=600, font=("Arial", 14))
        self.quantity_entry.pack(pady=20, fill="x")
        
        # Скидка
        ctk.CTkLabel(self.main_frame, text="Скидка (%):", font=("Arial", 14)).pack(anchor="w", pady=2)
        self.discount_entry = ctk.CTkEntry(self.main_frame, width=600, font=("Arial", 14), placeholder_text="0-100")
        self.discount_entry.pack(pady=20, fill="x")
        ...
        self.photo_label = ctk.CTkLabel(self.main_frame, text="", width=150, height=150)
